# ImmortalWrt for Philips-hy3000
...
```bash
git clone https://github.com/Yuzhii0718/immortalwrt-mt798x-philips-hy3000.git
```
...
- Using macOS as the host build OS is **not** recommended. No warranty at all. You can get tips from [Build system setup macOS](https://openwrt.org/docs/guide-developer/build-system/buildroot.exigence.macosx) documentation.
